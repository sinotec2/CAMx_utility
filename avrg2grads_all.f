c this routine calculate all time average of AVRG fields, and OP AS A ARG FILE
     ...
     &            'jul' ,'aug' ,'sep' ,'oct' ,'nov' ,'dec'/
      NUAV=41
      narg=iARGc ()
      if(narg.ne.1)stop  'avrg2grads_all File'
...
!loop over timesteps
     ...
     & int(tim(1,1)),'Z',ID,amonth(IM),2000+IY,nt,'hr'
